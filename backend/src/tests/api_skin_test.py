...
from src.api.config.settings import API_PREFIX, DOMAIN, PORT


def test_skin_plan_generation():
    """Test the skin plan generation API endpoint"""
    base_url = f"http://localhost:8000{API_PREFIX}"  # todo not sure of this endpoint
    ...
    print("\nTest Case 3: Test with non-existent user")
    params_3 = {"user_id": "non_existent_user", "model_name": "medllama2"}
